...
function RekapBarChart({ data: rekapRumija }) {
  const datasetPemanfaatan = {
    label: 'Pemanfaatan',
    data: rekapRumija['Pemasangan Reklame'].map((elem) => elem.pemanfaatan),
  ...
  const datasetPelanggaran = {
    label: 'Pelanggaran',
    data: rekapRumija['Pemasangan Reklame'].map((elem) => elem.pelanggaran),
...
export default function ReklameChart() {

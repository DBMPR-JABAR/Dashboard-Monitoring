  ...
  return (
    ...
    >
      <Bar
        ...
        data={data}
        plugins={[ticksOnClickPlugin((labelInfo) => console.log(labelInfo))]}
      />
    </div>
  )
}
...
export default function TalikuatChart() {
  ...
  const showRekapTalikuatChart = () => {
    ...
    if (!isEmptyOrSpaces(talikuatState.error)) {
      ...
      return <Chart talikuatData={talikuatState.data} />
    }
  }

  return showRekapTalikuatChart()
}
